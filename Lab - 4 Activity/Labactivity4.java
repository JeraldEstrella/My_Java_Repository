...
public class LabActivity4 {
    ...
    public static void main(String[] args) {
        ...
        Label rateLabel = new Label("Hours Worked");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(hours.matches("[a-zA-Z]") && rate.matches("[a-zA-Z]")){
                    outputTextfield.setText("Error: Hours worked and Rate worked must be a valid number");
                    return;
                };
